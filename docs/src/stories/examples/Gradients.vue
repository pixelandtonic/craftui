    ...
    <div>
        ...
        <div class="bg-secondary-background mt-6 p-8">
            <pane class="h-64 overflow-hidden relative">
                ...
                <div class="absolute bottom-0 w-full text-center -mx-6">
                    <div class="bg-gradient-primary-gradient h-24"></div>
                    <div class="bg-primary-background p-3">
                        <a @click.prevent="" href="#" class="text-interactive-link p-4 py-4 inline-block">More</a>
                    </div>
                </div>
            </pane>
        </div>
